...
mod test {
    ...
    use crate::{
        core::{
            aabb::Bounds2,
            camera::{
                orthographiccamera::OrthographicCamera, perspecttivecamera::PerspectiveCamera,
                CameraAble,
            },
            film::Film,
    ...
    fn test_camera_perspective() {
        ...
        let sphere = Sphere::new(Mat4::IDENTITY, false, 1.0, -1.0, 1.0, 360.0);
